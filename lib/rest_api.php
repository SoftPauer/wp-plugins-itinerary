...
add_action('rest_api_init', function () {
  ...
  register_rest_route(
    'itinerary/v1',
    'costings/delete/(?P<itinerary_id>\d+)',
    array(
      'methods' => WP_REST_Server::DELETABLE,
  ...
  register_rest_route(
    'itinerary/v1',
    'sections/delete/(?P<section_id>\d+)',
    array(
      'methods' => WP_REST_Server::DELETABLE,
  ...
  register_rest_route(
    'itinerary/v1',
    'values/(?P<itinerary_id>\d+)/(?P<section_id>\d+)',
    array(
      'methods' => WP_REST_Server::READABLE,
  ...
  register_rest_route(
    'itinerary/v1',
    'values/copyItinerary/(?P<itin_id>\d+)',
    array(
      'methods' => WP_REST_Server::EDITABLE,
  ...
  register_rest_route(
    'itinerary/v1',
    'rocketChannel/getChannels/(?P<itinerary_id>\d+)/(?P<section_id>\d+)',
    array(
      'methods' => WP_REST_Server::READABLE,
  ...
  register_rest_route(
    'itinerary/v1',
    'itineraries/updateReport/(?P<itinerary_id>\d+)',
    array(
      'methods' => WP_REST_Server::READABLE,
  ...
  register_rest_route(
    'itinerary/v1',
    'itineraries/getDashboardFields',
    array(
      'methods' => WP_REST_Server::READABLE,
  ...
  register_rest_route(
    'itinerary/v1',
    'itineraries/generateReport/(?P<itinerary_id>\d+)',
    array(
      'methods' => WP_REST_Server::READABLE,
  ...
  register_rest_route(
    'itinerary/v1',
    'itineraries/addDashboardField/(?P<field_id>\d+)',
    array(
      'methods' => WP_REST_Server::EDITABLE,
