...
function subscriber_invite_email($token, $eventTitle)
{
  ...
  >
    ...
    max-width: 1000px;
      ...
      <tr style='display: block; width: 100%; justify-content: center'>
      ...
      <tr style='display: flex; justify-content: center'>
        <td style='display: flex; justify-content: center; width: 100%'>
          <table style='text-align: center; width: 100%; padding: 40px 0;'>
            <tr>
              <td>
      ...
      <tr style='display: flex; width: 100%'>
        <td style='display: flex; width: 100%'>
          ...
          >
            ...
            <tr>
              <td style='width: 60%'>
                <p style='font-size: 1.5rem; padding-bottom: 30px'>
            ...
            <tr style='display:block; width: 100%'>
              ...
              min-width: 300px;'>
                ...
                >
                  ...
                  <tr>
                    <td colspan='2'>
                      <p style='text-align: left; font-size: 1.2rem; margin: 1em 0 0 0'>
                  ...
                  <tr>
                    <td style='width: 50%'>
                      <div
                        ...
                        height: 80px;
                        width: 100%;
                          background-image: url(https://eventr.bwtsoftpauer.com/email-images/AppStore.png);
                          background-repeat: no-repeat;
                          background-size: contain;
                          background-position: center;
                        '
                    ...
                    <td style='width: 50%'>
                      <div
                        ...
                        height: 80px;
                        width: 100%;
                          background-image: url(https://eventr.bwtsoftpauer.com/email-images/GooglePlay.png);
                          background-repeat: no-repeat;
                          background-size: contain;
                          background-position: center;
                        '
      ...
      <tr style='display: flex; justify-content: center; padding: 40px 0 0 0'>
        <td style='width: 100%'>
          <p style='font-size: 1.5rem'>
      ...
      <tr style='display: flex; justify-content: center; padding: 0 0 40px 0'>
        <td style='width: 100%'>
          <p style='font-size: 1.5rem'>The Eventr team.</p>
        </td>
      </tr>
      <tr style='display: flex; justify-content: center'>
        <td style='display: flex; justify-content: center; width: 100%'>
